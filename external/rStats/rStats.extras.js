...
window.threeStats = function ( renderer ) {
  ...
  var _groups = [ {
    ...
    values: [ 'renderer.info.render.calls', 'renderer.info.render.triangles', 'renderer.info.render.points', 'renderer.info.render.lines', 'renderer.info.render.frame' ]
  } ];
  ...
  function _update () {
    ...
    _rS( 'renderer.info.render.frame' ).set( renderer.info.render.frame );
